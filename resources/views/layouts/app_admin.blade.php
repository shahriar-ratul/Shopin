  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
       ...
       <li class="active treeview">
          <a href="{{  url('/') }}/">
            <i class="fa fa-dashboard"></i> <span>Font view</span>          
          </a>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url('/manage-product')}}"><i class="fa fa-circle-o"></i> Create Product</a></li>
            <li><a href="{{ url('/show-products')}}"><i class="fa fa-circle-o"></i> All Products</a></li>
          </ul>
        </li>
       
        <li><a href="#"><i class="fa fa-circle-o text-yellow"></i> <span>All Orders</span></a></li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{ url('admin/category/show')}}"><i class="fa fa-circle-o"></i> All Category</a></li>
          </ul>
        </li>
      </ul>
    </section>
