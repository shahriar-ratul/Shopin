...
<div class="banner-top">
	<div class="container">
		<h1>Products</h1>
		<em></em>
		<h2><a href="{{url('/')}}">Home</a><label>/</label>Products</a></h2>
	</div>
</div>
	<!--content-->
		<div class="product">
			<div class="container">
			<div class="col-md-9">
				@foreach($data['info']->chunk(3) as $chunk)
			<div class="mid-popular">
				@foreach ($chunk as $row)
					<div class="col-md-4 item-grid1 simpleCart_shelfItem">
					<div class=" mid-pop">
					<div class="pro-img">
						<img src="{{ asset('/')}}/public/product_images/{{ $row->product_image }}" class="img-responsive" alt="">
						<div class="zoom-icon ">
						<a class="picture" href="{{ asset('/')}}/public/product_images/{{ $row->product_image }}" rel="title" class="b-link-stripe b-animate-go  thickbox"><i class="glyphicon glyphicon-search icon "></i></a>
						<a href="{{url('/')}}/product-details/{{$row->product_row_id}}"><i class="glyphicon glyphicon-menu-right icon"></i></a>
						</div>
						</div>
						<div class="mid-1">
						<div class="women">
						<div class="women-top">
							...
							<div class="img item_add">
								<a href="{{url('/')}}/product-details/{{$row->product_row_id}}"><img src="{{asset('/public/web/')}}/images/ca.png" alt=""></a>
							</div>
							<div class="clearfix"></div>
							</div>
							<div class="mid-2">
								<p ><em class="item_price">TK{{ $row->product_price }}</em></p>
								  <div class="block">
