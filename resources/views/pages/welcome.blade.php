			...
			<div class="container">
				<div class="content-top">
					<div class="col-md-6 col-md">
						<div class="col-1">
						 <a href="{{url('/')}}" class="b-link-stroke b-animate-go  thickbox">
		   <img src="{{asset('/public/web/')}}/images/pi.jpg" class="img-responsive" alt=""/><div class="b-wrapper1 long-img"><p class="b-animate b-from-right    b-delay03 ">Lorem ipsum</p><label class="b-animate b-from-right    b-delay03 "></label><h3 class="b-animate b-from-left    b-delay03 ">Trendy</h3></div></a>
					...
					<div class="col-md-6 col-md1">
						<div class="col-3">
							<a href="{{url('/')}}/products"><img src="{{asset('/public/web/')}}/images/pi1.jpg" class="img-responsive" alt="">
							<div class="col-pic">
								<p>Lorem Ipsum</p>
								<label></label>
								<h5>For Men</h5>
						...
						<!--
						<div class="col-3">
							<a href="single.html"><img src="{{asset('/public/web/')}}/images/pi2.jpg" class="img-responsive" alt="">
							<div class="col-pic">
								<p>Lorem Ipsum</p>
								<label></label>
								<h5>For Kids</h5>
						...
						-->
						<div class="col-3">
							<a href="{{url('/')}}/products"><img src="{{asset('/public/web/')}}/images/pi3.jpg" class="img-responsive" alt="">
							<div class="col-pic">
								<p>Lorem Ipsum</p>
								<label></label>
								<h5>For Women</h5>
			...
			<div class="content-mid">
				...
				<div class="mid-popular">
					...
					<div class=" mid-pop">
					<div class="pro-img">
						<img src="{{asset('/public/web/')}}/images/pc.jpg" class="img-responsive" alt="">
						<div class="zoom-icon ">
						...
						<div class="women-top">
							<span>Women</span>
							<h6><a href="single.html">T-Shirt</a></h6>
							</div>
							<div class="img item_add">
								<a href="#"><img src="{{asset('/public/web/')}}/images/ca.png" alt=""></a>
							</div>
							<div class="clearfix"></div>
							</div>
							<div class="mid-2">
								<p ><label>TK-1000.00</label><em class="item_price">TK-700.00</em></p>
								  <div class="block">
					...
					<div class=" mid-pop">
					<div class="pro-img">
						<img src="{{asset('/public/web/')}}/images/pc1.jpg" class="img-responsive" alt="">
						<div class="zoom-icon ">
						...
						<div class="women-top">
							<span>Women</span>
							<h6><a href="single.html">Shirt</a></h6>
							</div>
							<div class="img item_add">
								<a href="#"><img src="{{asset('/public/web/')}}/images/ca.png" alt=""></a>
							</div>
					...
					<div class=" mid-pop">
					<div class="pro-img">
						<img src="{{asset('/public/web/')}}/images/pc2.jpg" class="img-responsive" alt="">
						<div class="zoom-icon ">
						...
						<div class="women-top">
							...
							<div class="mid-2">
								<p ><label>TK-1200.00</label><em class="item_price">TK-750.00</em></p>
								  <div class="block">
									<div class="starbox small ghosting"> </div>
								</div>
					...
					<div class=" mid-pop">
					<div class="pro-img">
						<img src="{{asset('/public/web/')}}/images/pc3.jpg" class="img-responsive" alt="">
						<div class="zoom-icon ">
						...
						<div class="women-top">
							...
							<div class="mid-2">
								<p ><label>Tk-500.00</label><em class="item_price">TK-300.00</em></p>
								  <div class="block">
									<div class="starbox small ghosting"> </div>
								</div>
					...
					<div class=" mid-pop">
					<div class="pro-img">
						<img src="{{asset('/public/web/')}}/images/pc4.jpg" class="img-responsive" alt="">
						<div class="zoom-icon ">
					...
					<div class=" mid-pop">
					<div class="pro-img">
						<img src="{{asset('/public/web/')}}/images/pc5.jpg" class="img-responsive" alt="">
						<div class="zoom-icon ">
					...
					<div class=" mid-pop">
					<div class="pro-img">
						<img src="{{asset('/public/web/')}}/images/pc6.jpg" class="img-responsive" alt="">
						<div class="zoom-icon ">
					...
					<div class=" mid-pop">
					<div class="pro-img">
						<img src="{{asset('/public/web/')}}/images/pc7.jpg" class="img-responsive" alt="">
						<div class="zoom-icon ">
