                    ...
                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-4 control-label" for="email">Product Sku</label> 
                                                    <div class="col-md-6">
                                                        <input id="product_sku" name="product_sku" type="text" value="{{$row->product_sku}}" class="form-control input-md" > 
                                                    </div>
                                            </div>
                                ...
                                <div class="form-group">
                                    <label class="col-md-4 control-label" for="email"> product_height</label> 
                                        <div class="col-md-6">
                                            <input id="Product" name="product_height" value="{{$row->product_height}}" type="text" class="form-control input-md" > 
                                        </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="col-md-4 control-label" for="email">Product Width</label> 
                                        <div class="col-md-6">
                                            <input id="product_width" name="product_width" value="{{$row->product_width}}" type="text" class="form-control input-md"> 
                                        </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="col-md-4 control-label" for="email">Product Weight</label> 
                                        <div class="col-md-6">
                                            <input id="product_weight" name="product_weight" value="{{$row->product_weight}}" type="text" class="form-control input-md"> 
                                        </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="col-md-4 control-label" for="email">Product short Description</label> 
                                        <div class="col-md-6">
                                            <textarea name="product_short_description" value="{{$row->product_short_description}}" rows="5"></textarea>
                                            <br/>
                                        </div>
                                </div>
                                <div class="form-group">
