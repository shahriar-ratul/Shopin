...
<div class="container wrapper">
    ...
    <div class="row cart-body">
        <form class="form-horizontal" method="post" action="{{url('/')}}/confirm-order">
            {!! csrf_field() !!}
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <select class="col-md-12 form-control" name="district" id="district" required="">
                        ...
                        <div class="form-group col-md-12">
                            <div class="col-md-12"><strong>Upazilla:</strong></div>
                            <select class="col-md-6 form-control" name="upazila" id="upazila" required="">
                                <option value="0">Select</option>
                            </select>
                        </div>
                        <div class="form-group">
